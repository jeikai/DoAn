  ...
  <TeacherLayout>
    <div class="mt-12 flex gap-8">
      <div class="flex-1 border flex flex-col h-fit">
        <div
          class="pt-12 px-8 text-center flex justify-center flex-col w-full items-center"
        >
          <img
        ...
        <div class="px-8">
          ...
          <div
            class="mt-4"
            v-if="projectInfo.isApproved == 'Đã xét duyệt'"
          >
        ...
        <div
          class="flex gap-4 my-4 m-auto"
          v-if="
            projectInfo.isApproved == 'Chưa được chấp nhận' &&
              ...
              >
                ...
                >
                  <UInput
                    ...
                    placeholder="Comment of project"
                  />
                </UFormGroup>
                <UButton type="submit"> Submit </UButton>
              </UForm>
...
<script setup lang="ts">
  ...
  async function loadData() {
    try {
      ...
      const response_userData = await axios.get(
        `http://localhost:5000/api/user/getUserInfor/${userId}`
      );
  ...
  function exportToPdf() {
    if (process.client) {
      ...
      if (pdfContentElement) {
        ...
        let w = window.open();
        w.document.write(pdfContentElement.outerHTML);
        w.document.close();
        w.print();
      } else {
