<template>
  ...
  <p
    ...
    "
  >
    1. Họ và tên sinh viên: {{ studentInfo?.name || '' }} 2. Mã số SV:
    {{ studentInfo?._id }}
  </p>
  <p
    style="
...
<script setup lang="ts">
  ...
  const { listMark, projectName, studentInfo, className } = defineProps([
    'listMark',
    'projectName',
    'studentInfo',
    'className',
