<template>
  <TeacherLayout>
    <div class="header flex gap-4 items-center h-14 border-b px-4">
      ...
      <div>
        <Icon
          name="material-symbols:groups-2"
          class="mr-4 mt-[2px] text-gray-500"
          size="25"
    ...
    <div class="px-4 w-full bg-[#f8f7fa]">
      <ul
        class="h-[calc(75vh-80px)] overflow-x-auto flex flex-col-reverse py-4"
      >
        <div
          v-for="msg in messages.listMessage"
          :key="msg"
        >
          <li
            class="flex gap-4 mb-4"
            :class="{ 'justify-end': msg.userId === userId }"
          >
            <div class="w-3/4">
